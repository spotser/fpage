...
# ============================================================
def get_page_token():
    url = f"https://graph.facebook.com/{FB_API_VERSION}/{FB_PAGE_ID}"
...
def get_instagram_account_id(page_token):
    ...
    r = requests.get(
        f"https://graph.facebook.com/{FB_API_VERSION}/{FB_PAGE_ID}",
        params={
...
def post_reel_to_facebook(video_path, caption, page_token):
    ...
    init_url = f"https://graph.facebook.com/{FB_API_VERSION}/{FB_PAGE_ID}/video_reels"
...
def post_story_to_facebook(video_path, page_token):
    ...
    try:
        ...
        story_init_url = f"https://graph.facebook.com/{FB_API_VERSION}/{FB_PAGE_ID}/video_stories"
