...
def generate_fb_caption(raw_caption: str) -> str | None:
    ...
    prompt = (
        ...
        f"Block 1 — Hook: One powerful attention-grabbing sentence in English with 1-2 relevant emojis. Max 100 chars. Use curiosity gap or emotional trigger.\n\n"
        f"Block 2 — Body: 2-3 lines of engaging value, storytelling or insight in English. Add 1 relevant emoji per line.\n\n"
        f"Block 3 — CTA: Must start on a NEW line after a blank line. Add 2-3 relevant emojis. Example: 👇 Like this post, share it with someone who needs this, drop your thoughts in the comments, and follow the page for daily motivation 🔔\n\n"
        f"Block 4 — Hashtags: Must start on a NEW line after a blank line. EXACTLY 20 trending Facebook hashtags separated by spaces. No emojis in hashtags.\n\n"
        f"IMPORTANT:\n"
        f"- ENGLISH ONLY — absolutely no Hindi or Hinglish\n"
        f"- Use appropriate emojis naturally — not too many, not too few\n"
        f"- No markdown, no asterisks, no bold text\n"
        f"- No placeholders\n"
        f"- CTA and Hashtags MUST each be on their own separate line with a blank line before them\n"
