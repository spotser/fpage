...
def generate_fb_caption(raw_caption: str) -> str | None:
    ...
    prompt = (
        ...
        f"Block 3 — CTA: Must start on a NEW line after a blank line. Example: Like this post, share it with someone who needs this, drop your thoughts in the comments, and follow the page for daily motivation.\n\n"
        f"Block 4 — Hashtags: Must start on a NEW line after a blank line. EXACTLY 20 trending Facebook hashtags separated by spaces.\n\n"
        f"IMPORTANT:\n"
